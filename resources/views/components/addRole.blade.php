              ...
              <div class="p-4 md:p-5 space-y-4">
                <form action="{{route('roles.store')}}" method="post">
                    ...
                    <div class="mb-6">
                        ...
                        <br>
                        <button data-modal-hide="add-modal" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Enregistrer</button>
                    </div>
                </form>
              </div>
              <!-- Modal footer -->
