...
@foreach ($per_course as $permission)
        ...
        <td class="px-7 py-4" >
            @if ($permission === 'lire_course')
                <div class="flex items-center">
                    <input data-modal-target="check-course"  data-modal-toggle="check-course"  id="checkbox" onclick="LireCr(event)"  type="checkbox" class="w-4 h-4 text-orange-500 bg-gray-100 border-gray-300 rounded focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" name="checkbox_{{$permission}}">
            ...
            @if ($permission === 'enregistrer_course')
                <div class="flex items-center">
                    <input data-modal-target="check-course"  data-modal-toggle="check-course"  id="checkbox" onclick="EnregistrerCr(event)"  type="checkbox" class="w-4 h-4 text-orange-500 bg-gray-100 border-gray-300 rounded focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" name="checkbox_{{$permission}}">
                    <a id="check-{{$permission}}" href="{{route('assign_permission',['name' => $permission, 'role' => $roleId])}}"></a>
            ...
            @if ($permission === 'supprimer_course')
                <div class="flex items-center">
                    <input data-modal-target="check-course"  data-modal-toggle="check-course"  id="checkbox" onclick="SupprimerCr(event)"  type="checkbox" class="w-4 h-4 text-orange-500 bg-gray-100 border-gray-300 rounded focus:ring-orange-500 dark:focus:ring-orange-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" name="checkbox_{{$permission}}">
                    <a id="check-{{$permission}}" href="{{route('assign_permission',['name' => $permission, 'role' => $roleId])}}"></a>
